...
REM
REM Generated by Vivado on Wed Oct 15 21:05:04 +0530 2025
...
echo "xvlog --incr --relax -prj day2_Zero_vlog.prj"
call xvlog  --incr --relax -prj day2_Zero_vlog.prj -log xvlog.log
