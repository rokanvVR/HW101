...
REM
REM Generated by Vivado on Sat Oct 18 11:47:40 +0530 2025
...
echo "xvlog --incr --relax -prj wire_decl_vlog.prj"
call xvlog  --incr --relax -prj wire_decl_vlog.prj -log xvlog.log
