...
REM
REM Generated by Vivado on Wed Oct 15 19:45:50 +0530 2025
...
echo "xvlog --incr --relax -prj gates_stimuli_vlog.prj"
call xvlog  --incr --relax -prj gates_stimuli_vlog.prj -log xvlog.log
