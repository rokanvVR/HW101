...
REM
REM Generated by Vivado on Wed Oct 15 21:19:16 +0530 2025
...
echo "xvlog --incr --relax -prj wires4_vlog.prj"
call xvlog  --incr --relax -prj wires4_vlog.prj -log xvlog.log
